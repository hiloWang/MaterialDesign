...
public class AnimUtils {
    ...
    public static void toBigAnim(View view) {
        ScaleAnimation animation = new ScaleAnimation(0.0f, 1.0f, 0.0f, 1.0f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.0f);
        animation.setDuration(1000);
        animation.setFillAfter(true);
    ...
    public static void toSmallAnim(View view) {
        ScaleAnimation animation = new ScaleAnimation(1.0f, 0.0f, 1.0f, 0.0f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.0f);
        animation.setDuration(1000);
    ...
    public static AlertDialog getProgressDialog(Activity activity) {
        ...
        Animator anim1 = setRepeatableAnim(activity, img1, ANIMATION_DURATION, R.anim.progress_dialog_anim);
        Animator anim2 = setRepeatableAnim(activity, img2, ANIMATION_DURATION, R.anim.progress_dialog_anim);
        Animator anim3 = setRepeatableAnim(activity, img3, ANIMATION_DURATION, R.anim.progress_dialog_anim);
